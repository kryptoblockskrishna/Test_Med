...
public class Health_Packages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_health__packages);

        c1=(CardView)findViewById(R.id.hp_pro_filter_card);
        t1 = (TextView) findViewById(R.id.hp_pro_filter_title);
        iv1 = (ImageView)findViewById(R.id.hp_pro_filter_arrow);
        iv2 = (ImageView)findViewById(R.id.hp_pro_iv);
